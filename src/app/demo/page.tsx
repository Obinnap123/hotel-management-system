  ...
  return (
    <div>
      <PublicHero
        ...
        featuredRoomsVisible={config.website.sectionVisibility.showFeaturedRooms}
        heroImages={config.website.heroImages.map((image) => image.url)}
      />

      {config.website.sectionVisibility.showFeaturedRooms ? (
      ...
      {config.website.sectionVisibility.showFacilities ? (
        <HomeAmenities
          copy={config.website.copy}
          facilities={config.website.facilities}
        />
      ) : null}
      {config.website.sectionVisibility.showAboutHotel ? (
        <AboutHotel
          copy={config.website.copy}
      ...
      {config.website.sectionVisibility.showBookingSteps ? (
        <Testimonials />
      ) : null}
    </div>
  );
