        ...
        {statCards.map((stat) => (
          ...
          >
            <div className="flex min-w-0 items-start justify-between gap-3">
              ...
              <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-zinc-100 text-zinc-700">
            ...
            <tbody>
              {recentPayments.map((payment) => (
                <tr className="border-b border-zinc-100" key={payment.id}>
                  ...
                  <td className="py-3 text-zinc-700">{payment.paymentDate}</td>
                </tr>
              ))}
            </tbody>
          </table>
  ...
  return (
    <section className="min-w-0 rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
      ...
      <div className="dashboard-card-scroll mt-4 space-y-3">
        ...
        {bookings.length === 0 ? (
          <p className="py-4 text-sm text-zinc-500">No records to show.</p>
        ) : null}
      </div>
    </section>
  );
