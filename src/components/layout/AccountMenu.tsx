...
export function AccountMenu({ email, fullName, role }: AccountMenuProps) {
  ...
  return (
    <div className="relative">
      <button
        className="inline-flex h-10 items-center gap-2 rounded-md border border-zinc-300 px-3 text-sm font-medium text-zinc-800 transition hover:bg-zinc-50"
      ...
      {open ? (
        <div className="absolute right-0 z-30 mt-2 w-64 rounded-md border border-zinc-200 bg-white p-2 shadow-lg">
          <div className="border-b border-zinc-100 px-3 py-2">
            <p className="font-medium text-zinc-950">{fullName}</p>
